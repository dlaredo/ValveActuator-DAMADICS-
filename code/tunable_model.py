...
class SequenceTunableModelRegression(TunableModel):
		...
		def load_data(self, unroll=False, cross_validation_ratio=0, test_ratio=0, verbose=0):
			...
			self._data_handler.load_data(unroll=unroll, verbose=verbose, cross_validation_ratio=cross_validation_ratio, test_ratio=test_ratio)
